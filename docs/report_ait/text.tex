...
\begin{figure}
\includegraphics[width=7cm]{clove_hitch1.eps}
\label{pic:clove_hitch1.eps}
\caption{clove hitch1.eps}
\end{figure}

\begin{figure}
\includegraphics[width=7cm]{navigation.eps}
...
\begin{figure}
\includegraphics[width=7cm]{x11renderer.eps}
\label{pic:x11renderer.eps}
\caption{Linux 11 test application}
\end{figure}

\begin{figure}
\includegraphics[width=7cm]{bind_package.eps}
...
\begin{figure}
\includegraphics[width=7cm]{structure.eps}
...
\begin{figure}
\includegraphics[width=7cm]{fileDialog_package.eps}
